...
This is extension is under active development, and changes in each release are documented in the [CHANGELOG](https://github.com/richjyoung/vscode-modern-vhdl/blob/master/./CHANGELOG.md)
